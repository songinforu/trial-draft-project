...
onMounted(() => {
  getCapacityHomeList({ type: "scmy" }).then((res) => {
              ...
              <div class="flex-1">
                ...
                <div class="flex mt-20px">
                  <div class="mr-40px">
                    ...
                    <p class="device-wrapper">未来7天空闲产能</p>
                  </div>
                  <div class="mr-40px">
                    <p class="number-wrapper">999+</p>
                    <p class="device-wrapper">所有设备</p>
                  </div>
                  <div>
                    <p class="number-wrapper">999+</p>
                    <p class="device-wrapper">空闲设备</p>
                  </div>
                </div>
...
.demand-homeList-container {
  height: 1036px;
  background: url(@/assets/images/blockchain-bg.png) no-repeat center center;
