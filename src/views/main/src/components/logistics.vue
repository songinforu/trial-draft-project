...
onMounted(() => {
  getLogistics({ pagesize: 6 }).then((res) => {
        ...
        >
          ...
          <div class="p-24px pt-16px">
            <p class="card-item-title">
              <span class="w-72px overflow-hidden text-ellipsis">
                {{ item.title }}
              </span>
            ...
            <div class="address-wrapper">
              <div class="flex items-center">
                ...
                <span
                  class="ml-8px overflow-hidden w-200px whitespace-nowrap text-ellipsis"
...
.demand-homeList-container {
  max-height: 1049px;
  background: url(@/assets/images/logistics-bg.png) no-repeat center center;
